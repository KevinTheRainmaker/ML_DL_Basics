...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--update_html_freq', type=int, default=500,
        ...
        parser.add_argument('--g_lr_ratio', type=float, default=1.0,
                            help='a ratio for changing learning rate of generator')  # mia
        parser.add_argument('--d_lr_ratio', type=float, default=1.0,
                            help='a ratio for changing learning rate of discriminator')  # mia
        ...
        parser.add_argument('--gp_ratio', type=float,
                            default=1.0, help='weight for gradient_penalty')
        parser.add_argument('--lambda_a', type=float,
                            default=1.0, help='weight for adversarial loss')
        parser.add_argument('--lambda_v', type=float,
                            default=1.0, help='weight for verification loss')
        self.isTrain = True
        return parser
