...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_root', required=True,
                            type=str, help='path to iHarmony4 dataset')  # mia
        parser.add_argument('--name', type=str, default='result_temp',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0',
                            help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str,
                            default='./checkpoints/scratch_pa3_256_wo_RAIN/', help='models are saved here')
        ...
        parser.add_argument('--input_nc', type=int, default=4,
                            help='# of input image channels: 4 for concated comp and mask')  # mia
        ...
        parser.add_argument('--normG', type=str, default='RAN_Method1',
                            help='Regional Adaptive Normalization or batch normalization [instance | batch | none]')
        ...
        parser.add_argument('--dataset_mode', type=str,
                            default='iharmony4', help='load iHarmony4 dataset')  # mia
        ...
        parser.add_argument('--load_iter', type=str, default='0',
